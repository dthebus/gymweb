 ...
 * @author darren
 */
public class TotalSaladsServiceTest {
    
    public TotalSaladsServiceTest() {
    }

   public static ApplicationContext ctx;
    private TotalSaladsService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalSaladsService.class);
         List<Salad> entities = service.getTotal();
