 ...
 * @author darren
 */
public class TotalWrapsServiceTest {
    
    public TotalWrapsServiceTest() {
    }

   public static ApplicationContext ctx;
    private TotalWrapsService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalWrapsService.class);
         List<Wrap> entities = service.getTotal();
