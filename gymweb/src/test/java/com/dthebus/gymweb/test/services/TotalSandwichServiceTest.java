 ...
 * @author darren
 */
public class TotalSandwichServiceTest {
    
    public TotalSandwichServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalSandwichService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalSandwichService.class);
         List<Sandwich> entities = service.getTotal();
