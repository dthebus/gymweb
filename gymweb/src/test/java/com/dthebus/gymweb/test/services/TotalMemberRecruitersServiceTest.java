 ...
 * @author darren
 */
public class TotalMemberRecruitersServiceTest {
    
    public TotalMemberRecruitersServiceTest() {
    }

   public static ApplicationContext ctx;
    private TotalMemberRecruitersService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalMemberRecruitersService.class);
         List<MemberRecruiter> entities = service.getTotal();
