 ...
 * @author darren
 */
public class TotalEnergyDrinksServiceTest {
    
    public TotalEnergyDrinksServiceTest() {
    }

   public static ApplicationContext ctx;
    private TotalEnergyDrinksService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalEnergyDrinksService.class);
         List<EnergyDrink> entities = service.getTotal();
