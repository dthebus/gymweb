 ...
 * @author darren
 */
public class TotalSupplierServiceTest {
    
    public TotalSupplierServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotaSupplierService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotaSupplierService.class);
         List<Supplier> entities = service.getTotal();
