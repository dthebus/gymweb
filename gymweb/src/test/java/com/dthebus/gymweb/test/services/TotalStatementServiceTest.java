 ...
 * @author darren
 */
public class TotalStatementServiceTest {
    
    public TotalStatementServiceTest() {
    }

   public static ApplicationContext ctx;
    private TotalStatementService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalStatementService.class);
         List<Statement> entities = service.getTotal();
