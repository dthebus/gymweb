 ...
 * @author darren
 */
public class TotalProteinShakesServiceTest {
    
    public TotalProteinShakesServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalProteinShakesService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalProteinShakesService.class);
         List<ProteinShake> entities = service.getTotal();
