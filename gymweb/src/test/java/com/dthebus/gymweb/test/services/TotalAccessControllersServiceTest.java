 ...
 * @author darren
 */
public class TotalAccessControllersServiceTest {
    
    public TotalAccessControllersServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalAccessControllersService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalAccessControllersService.class);
         List<AccessController> entities = service.getTotal();
