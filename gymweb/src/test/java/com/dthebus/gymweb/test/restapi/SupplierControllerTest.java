...
public class SupplierControllerTest {
   ...
   public void testCreate(){
       Supplier d = new Supplier.Builder("USN").build();
       HttpEntity<Supplier> requestEntity = new HttpEntity<>(d, getContentType());
  
   ResponseEntity<String> responseEntity = restTemplate.
           exchange(URL+"api/supplier/create", HttpMethod.POST, requestEntity, String.class);
