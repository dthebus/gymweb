 ...
 * @author darren
 */
public class TotalCleanersServiceTest {
    
    public TotalCleanersServiceTest() {
    }

   public static ApplicationContext ctx;
    private TotalCleanersService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalCleanersService.class);
         List<Cleaner> entities = service.getTotal();
