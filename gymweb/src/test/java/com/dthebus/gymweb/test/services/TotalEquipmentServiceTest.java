 ...
 * @author darren
 */
public class TotalEquipmentServiceTest {
    
    public TotalEquipmentServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalEquipmentService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalEquipmentService.class);
         List<Equipment> entities = service.getTotal();
