...
public class EquipmentControllerTest {
   ...
   public void testCreate(){
       Equipment d = new Equipment.Builder("Treadmil").build();
       HttpEntity<Equipment> requestEntity = new HttpEntity<>(d, getContentType());
  
   ResponseEntity<String> responseEntity = restTemplate.
           exchange(URL+"api/equipment/create", HttpMethod.POST, requestEntity, String.class);
