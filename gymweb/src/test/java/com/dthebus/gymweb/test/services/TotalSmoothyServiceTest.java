 ...
 * @author darren
 */
public class TotalSmoothyServiceTest {
    
    public TotalSmoothyServiceTest() {
    }

    public static ApplicationContext ctx;
    private TotalSmoothyService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalSmoothyService.class);
         List<Smoothy> entities = service.getTotal();
