 ...
 * @author darren
 */
public class TotalManagersServiceTest {
    
    public TotalManagersServiceTest() {
    }

   public static ApplicationContext ctx;
    private TotalManagersService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalManagersService.class);
         List<Manager> entities = service.getTotal();
