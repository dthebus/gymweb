 ...
 * @author darren
 */
public class TotalConsumableServiceTest {
    
    public TotalConsumableServiceTest() {
    }

   public static ApplicationContext ctx;
    private TotalConsumableService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalConsumableService.class);
         List<Consumable> entities = service.getTotal();
