 ...
 * @author darren
 */
public class TotalSnackServiceTest {
    
    public TotalSnackServiceTest() {
    }

  public static ApplicationContext ctx;
    private TotalSnackService service;
   
   
    @Test
     public void total() {
         service = ctx.getBean(TotalSnackService.class);
         List<Snack> entities = service.getTotal();
